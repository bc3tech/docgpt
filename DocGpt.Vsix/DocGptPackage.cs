namespace DocGpt.Vsix
{
    ...
    public sealed class DocGptPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "a8cd6a12-8766-4599-970d-98c205c83078";

        /// <summary>
        /// Initializes a new instance of the <see cref="DocGptPackage"/> class.
        /// </summary>
        public DocGptPackage()
        {
